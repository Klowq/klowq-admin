  ...
  return (
    <Link href="/blogs/The-Future-of-Anonymous-Healthcare">
      <div className="md:col-span-2 lg:col-span-1 group">
        <Card className="border border-border shadow-xl hover:shadow-3xl transition-all duration-500 bg-card h-full group-hover:-translate-y-2 rounded-3xl overflow-hidden">
          ...
          <CardContent className="py-8 px-4">
            ...
            <div className="py-3 gap-2 flex flex-wrap">
              <span className="px-3 py-1 text-xs rounded-full bg-muted text-foreground font-medium">
                Fitness
              </span>
              <span className="px-3 py-1 text-xs rounded-full bg-muted text-foreground font-medium">
                Healthcare
            ...
            <h3 className="text-2xl line-clamp-2 font-bold text-foreground mb-4 leading-tight tracking-tight group-hover:text-primary transition-colors">
