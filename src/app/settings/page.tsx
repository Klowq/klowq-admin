...
import { HiOutlineUser, HiOutlineLockClosed, HiOutlinePaintBrush, HiOutlineTrash } from 'react-icons/hi2';
...
export default function SettingsPage() {
  ...
  const handleDeleteAccount = async () => {
    ...
    try {
      ...
      await new Promise((r) => setTimeout(r, 600));
      setMessage({ type: 'error', text: 'Account deletion is disabled in this demo.' });
    } finally {
      setSaving(false);
    }
  };
    ...
    <DashboardLayout>
      <div className="p-6 max-w-5xl mx-auto">
        <div className="flex flex-col md:flex-row gap-8">
          {/* Left nav */}
          <nav className="md:w-56 shrink-0" aria-label="Settings">
